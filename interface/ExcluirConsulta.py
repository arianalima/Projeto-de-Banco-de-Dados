...
class Ui_DialogAgenCons(object):
    def setupUi(self, DialogAgenCons,codCli,codMed,data,hora):
        ...
        self.formLayoutEspec.setWidget(1, QtGui.QFormLayout.LabelRole, self.labelCodCliCons)
        self.campoCodCliCons = QtGui.QLineEdit(self.formLayoutWidget)
        self.campoCodCliCons.setObjectName(_fromUtf8("campoCodCliCons"))
        self.formLayoutEspec.setWidget(1, QtGui.QFormLayout.FieldRole, self.campoCodCliCons)

        self.labelCodMedCons = QtGui.QLabel(self.formLayoutWidget)
        self.labelCodMedCons.setObjectName(_fromUtf8("labelCodMedCons"))
        self.formLayoutEspec.setWidget(2, QtGui.QFormLayout.LabelRole, self.labelCodMedCons)
        self.campoCodMedCons = QtGui.QLineEdit(self.formLayoutWidget)
        self.campoCodMedCons.setObjectName(_fromUtf8("campoCodMedCons"))
        self.formLayoutEspec.setWidget(2, QtGui.QFormLayout.FieldRole, self.campoCodMedCons)

        self.labelDataCons = QtGui.QLabel(self.formLayoutWidget)
        self.labelDataCons.setObjectName(_fromUtf8("labelDataCons"))
        self.formLayoutEspec.setWidget(3, QtGui.QFormLayout.LabelRole, self.labelDataCons)
        self.campoDataCons = QtGui.QLineEdit(self.formLayoutWidget)
        self.campoDataCons.setObjectName(_fromUtf8("campoDataCons"))
        self.formLayoutEspec.setWidget(3, QtGui.QFormLayout.FieldRole, self.campoDataCons)

        self.labelHoraCons = QtGui.QLabel(self.formLayoutWidget)
        self.labelHoraCons.setObjectName(_fromUtf8("labelHoraCons"))
        self.formLayoutEspec.setWidget(4, QtGui.QFormLayout.LabelRole, self.labelHoraCons)
        self.campoHoraCons = QtGui.QLineEdit(self.formLayoutWidget)
        self.campoHoraCons.setObjectName(_fromUtf8("campoHoraCons"))
        self.formLayoutEspec.setWidget(4, QtGui.QFormLayout.FieldRole, self.campoHoraCons)

        self.btnCancelar = QtGui.QPushButton(DialogAgenCons)
        self.btnCancelar.setGeometry(QtCore.QRect(230, 160, 75, 23))
        self.btnCancelar.setObjectName(_fromUtf8("btnCancelar"))
        self.btnExcluir = QtGui.QPushButton(DialogAgenCons)
    ...
    def retranslateUi(self, DialogAgenCons):
        DialogAgenCons.setWindowTitle(_translate("DialogAgenCons", "Excluir Consulta", None))
        self.labelCons.setText(_translate("DialogAgenCons", "Excluir Consulta", None))
        ...
        self.btnExcluir.setText(_translate("DialogAgenCons", "Confirmar", None))
    ...
    def setCamposConsulta(self,codCli,codMed,data,hora):
        ...
        if boolean == True:
            ...
            self.campoDataCons.setText(data)
            self.campoDataCons.setReadOnly(True)
            self.campoHoraCons.setText(hora)
            self.campoHoraCons.setReadOnly(True)
    ...
    def Excluir(self):
        ...
        if len(codCliCons) and len(codMedCons) != 0:
            operacao = CRUD_Clinica.DesmarcarConsulta(codCliCons,codMedCons,dataCons,horaCons)
            self.popUp(operacao)
